  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-border bg-transparent hover:bg-surface-alt text-foreground',
        secondary:
          'bg-surface-alt text-foreground shadow-sm hover:bg-surface-alt/80',
        ghost: 'text-foreground hover:bg-surface-alt',
        link: 'text-primary underline-offset-4 hover:underline',
        safe: 'bg-safe text-white shadow-sm hover:bg-emerald-600 focus-visible:ring-safe',
        warning:
          'bg-warning text-black shadow-sm hover:bg-amber-600 focus-visible:ring-warning',
      },
      size: {
